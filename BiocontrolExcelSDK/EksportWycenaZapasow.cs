        ...
        public void MyActionZapasy()
        {
            ...
            if (result == true)
            {
                ...
                using (var workbook = new XLWorkbook())
                {
                    ...
                    worksheet.PageSetup.Margins.Left = 0.8;
                    worksheet.PageSetup.Margins.Right = 0.8;
                    worksheet.PageSetup.Margins.Top = 0.8;
                    worksheet.PageSetup.Margins.Bottom = 0.8;
                    worksheet.PageSetup.Margins.Footer = 0.76;

            ...
            if (result == true)
            {
                ...
                using (var workbook = new XLWorkbook())
                {
                    ...
                    using (Session session = Context.Login.CreateSession(false, false))
                    {
                        ...
                        {
                            if (zapis.Features["Konta Norweskie"] != null && zapis.Data.Year.ToString() == BaseParams.Year.ToString())
                            {
                                double value = (double)zapis.KwotaZapisu.Value;

                                if (zapis.Dekret.Ewidencja.Typ.ToString() == "SprzedażEwidencja") // sprzedaż
                                {
                                    if (zapis.NumerEwidencji.ToString().Contains("SPT"))
                                        salesRow = 0;
                                    else if (zapis.NumerEwidencji.ToString().Contains("SPU"))
                                        salesRow = 3;
                                    else
                                        salesRow = 666;
                                ...
                                else if (zapis.Dekret.Ewidencja.Typ.ToString() == "ZakupEwidencja") // zakup
                                {
